...
internal ClientFid9P *client9p_auth(Arena *arena, Client9P *client, String8 auth_server, String8 proto,
                                    String8 user_name, String8 attach_path, String8 server_hostname);
internal Client9P *client9p_mount(Arena *arena, u64 fd, String8 auth_server, String8 attach_path, String8 server_hostname, b32 use_auth);
