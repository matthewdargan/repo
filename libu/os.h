...
static b32 writefile(String8 path, String8 data);
static b32 appendfile(String8 path, String8 data);
...
static u64 openfd(String8 path, int flags);
...
static b32 osremove(String8 path);
static String8 abspath(String8 path);
static b32 fileexists(String8 path);
static b32 direxists(String8 path);
static Fprops osstat(String8 path);
static b32 osmkdir(String8 path);
