...
internal OS_FileProperties os_properties_from_file(OS_Handle file);
...
internal b32 os_directory_path_exists(String8 path);
internal OS_FileProperties os_properties_from_file_path(String8 path);
internal b32 os_make_directory(String8 path);

////////////////////////////////
//~ Socket Operations

internal OS_Handle os_socket_connect_tcp(String8 host, u16 port);
internal OS_Handle os_socket_connect_unix(String8 path);
