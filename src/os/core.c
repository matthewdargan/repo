...
os_string_list_from_argcv(arena *a, int argc, char **argv)
{
...
internal string8
os_data_from_file_path(arena *a, string8 path)
{
...
internal string8
os_string_from_file_range(arena *a, os_handle file, rng1u64 range)
{
...
internal tm
os_tm_from_date_time(date_time dt)
{
	tm result = {0};
...
internal timespec
os_timespec_from_date_time(date_time dt)
{
...
internal os_handle
os_file_open(int flags, string8 path)
{
...
internal b32
os_file_set_times(os_handle file, date_time dt)
{
	if (file == 0) {
		return 0;
	}
...
internal string8
os_full_path_from_path(string8 path)
{
	temp scratch = temp_begin(g_arena);
	string8 path_copy = push_str8_copy(scratch.a, path);
...
internal date_time
os_universal_time_from_local(date_time dt)
{
...
internal date_time
os_local_time_from_universal(date_time dt)
{
